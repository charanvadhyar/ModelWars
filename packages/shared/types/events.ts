...
// Typed WebSocket events — Server → Client
// ─────────────────────────────────────────────────────────────────────────────

import type { GameState, Move, Player, HeatmapGrid } from "./game";
...
export interface MatchStartPayload {
  ...
  shipLayoutA: import("./game").ShipPlacement[];
  shipLayoutB: import("./game").ShipPlacement[];
}
